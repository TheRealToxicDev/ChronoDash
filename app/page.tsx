...
import { FiActivity, FiRefreshCw, FiServer, FiCpu, FiArrowRight, FiZap, FiTrendingUp, } from "react-icons/fi";
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/services" className="text-sm text-primary hover:underline flex items-center space-x-1 font-medium">
                <span>View all</span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-green-500 text-3xl font-bold mb-1">{runningServices}</p>
                      <p className="text-sm font-medium text-green-600/80">Running Services</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-red-500 text-3xl font-bold mb-1">{stoppedServices}</p>
                      <p className="text-sm font-medium text-red-600/80">Stopped Services</p>
                    </div>
                  </motion.div>
                </div>
                
                <div className="space-y-3 mt-5">
                  <h3 className="text-sm font-medium text-muted-foreground">Recent Services</h3>
                  {services.slice(0, 3).map((service, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className={`w-2.5 h-2.5 rounded-full ${service.status === 'running' ? 'bg-green-500' : 'bg-red-500'} animate-pulse`}></div>
